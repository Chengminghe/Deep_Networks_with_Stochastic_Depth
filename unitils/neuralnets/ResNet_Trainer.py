...
class ResNetTrainer():
    ...
    """
    def __init__(self,X_train, y_train, X_val, y_val, epochs=10, batch_size=256, lr=1e-3,num_block):
    ...
    def init_model(self):
        self.model = ResNet(self.X_train.shape[1:])
    ...
    def train_epoch(self, epoch):
        ...
        for i in range(self.n_batches):
            train_data = next(self.train_data_next_batch)
            self.train_step(train_data[0],train_data[1])
